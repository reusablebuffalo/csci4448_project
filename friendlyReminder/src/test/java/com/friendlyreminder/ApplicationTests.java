...
public class ApplicationTests {
    ...
    public void setUp(){
        ...
        testEvent1 =  new CommunicationEvent(LocalDate.of(10, 10, 10),"testNote","testType");
        testEvent2 =  new CommunicationEvent(LocalDate.of(10,10,11),"testNote","testType");
        testEvent3 =  new CommunicationEvent(LocalDate.of(10,10,12),"testNote","testType");
        testEvent4 =  new CommunicationEvent(LocalDate.of(11,10,12),"testNote","testType");
        testEvent5 =  new CommunicationEvent(LocalDate.of(11,11,12),"testNote","testType");
